...
\hline
Description & A conversational chatbot powered by Generative AI provides real-time assistance, answers FAQs, guides users on features, and recommends rides using a Content-Based Recommendation Algorithm. \\
\hline
...
& $\bullet$ Generative AI API is available and properly integrated. \\
& $\bullet$ No human support is required; all queries handled by chatbot. \\
\hline
\end{longtable}
