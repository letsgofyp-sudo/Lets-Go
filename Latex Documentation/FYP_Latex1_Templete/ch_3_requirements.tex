...
\hline
Preconditions 
& $\bullet$ The user has filled out the registration form or made a request to change the contact information. \\
...
\hline
Description & Once a ride starts, the system offers almost real-time GPS location of the driver's vehicle and live estimated arrival times for passengers, and documents the route progress on an interactive map. The system supports GPS disconnection, can work out the arrival time based on distance and speed and can alert users of important events like proximity to pick-up points, delays, turns and drop-offs.. \\
\hline
Once verified that the ride has been picked up or confirmed to have started, the ride status will be updated to “In Progress”. GPS positioning begins after the driver has submitted an application, and he is beginning to transmit his position to the back-end system.

\hline
Normal Flow — Driver  
&1. The initial "ride" begins with the driver. \\
...
\hline
Preconditions 
& $\bullet$ The ride status is “In Progress.” \\
...
\hline
Postconditions 
& $\bullet$ Continuous location updates are available to authorized users during the ride. \\
...
\hline
Assumptions 
& $\bullet$ The accuracy of GPS is usually within 10 meters when the conditions are normal.
...
& 1. The driver makes it to the passenger's pick up point, and pulls up the passenger marker in the map.
...
\hline
Preconditions 
& $\bullet$ The booking is confirmed and the ride has not yet started for the passenger.
...
\hline
Normal Flow 
& 1. The passenger is letting the driver know that they've arrived and is being handed that driver's payment info or QR code. \\
...
\hline
Postconditions 
& $\bullet$ The status of the ride changes to Completed. \\
...
\hline
This use case is the process of emergency response that will be activated if an emergency occurs while your user is on the road. The system notifies emergency contacts, administrators and initiates an incident management flow in realtime and shares critical location and incident data. \\
\hline
Trigger & User presses the SOS button on the in-ride map screen (deliberate interaction, e.g., 321 countdown). \\
\hline
Normal Flow (Immediate SOS) 
& 1. The user has turned the SOS feature on purpose.
...
\hline
Preconditions 
& $\bullet$ The user is signed in and taking part in a live ride. \\
...
\hline
Postconditions 
& $\bullet$ Emergency contact and administrator receives urgent notification(s). \\
...
\hline
Assumptions 
& $\bullet$ Users supply accurate Emergency contact details. \\
