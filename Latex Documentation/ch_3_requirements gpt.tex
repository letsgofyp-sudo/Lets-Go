...
This chapter presents a structured and formal specification of the requirements for the Lets Go Ride Sharing App ride-sharing application. Its purpose is to define clearly what the system shall accomplish before the design phase begins. The requirements collected here provide the contractual basis for implementation, validation, and testing.

The analysis covers requirement elicitation techniques, stakeholder identification, use case modeling, functional requirements, non-functional requirements, and external interface requirements. All requirements are written in a measurable and testable form, following standard requirement engineering practice.
\section{Requirement Elicitation Techniques}

This section describes the techniques used to gather and refine system requirements. Requirement elicitation ensures that stakeholder expectations remain aligned with the system capabilities.

Requirements for the Lets Go Ride Sharing App project are identified using the following techniques:

\begin{itemize}
    \item Stakeholder interviews with potential drivers, passengers, and administrators to capture user expectations, pain points, and desired features.
    \item Literature review of existing ride-sharing platforms such as BlaBlaCar, InDrive, and Bykea, along with academic research on carpooling systems.
    \item Analysis of existing solutions to identify functional gaps, especially the lack of route-based matching and cultural preferences.
    \item Dataset examination for the machine learning module to study travel patterns and user behavior for recommendation features.
    \item Review of transportation workflows to understand manual verification, payment handling, and dispute management needs.
\end{itemize}
\section{User Classes and Characteristics}

This section defines the different user groups that interact with the Lets Go Ride Sharing App system. Their duties, privileges, and technical proficiency levels are classified by user type. This classification supports role-based access control and requirement mapping.
\section{System Overview}

The proposed Lets Go Ride Sharing App system follows a structured three-tier client-server architecture that supports modular interaction between user interfaces, processing logic, and data storage. The system allows role-based interaction and secure communication between users, internal modules, and external services.

The overall architecture is organized into the following tiers:

\begin{itemize}
    \item \textbf{Presentation Tier:} Cross-platform Flutter mobile applications for passengers and drivers, together with a web-based admin console built with HTML, CSS, and JavaScript.
    \item \textbf{Application Tier:} REST-style JSON APIs on the Django backend deliver all core features, including rides, bookings, chat, live tracking, safety, administration, and machine learning recommendations. Mobile clients use HTTP polling to support near real-time behavior.
    \item \textbf{Data Tier:} PostgreSQL, hosted through Supabase, stores transactional data while object storage is used for documents and uploaded media.
\end{itemize}

This architecture places the internal modules, user interfaces, data processing components, and third-party services such as Maps, Notifications, and LLM tools inside the system boundary. External entities interact with the system through clearly defined APIs.
\section{Use Case Model}

Use case modeling presents the high-level interactions between actors and system functionality. It establishes the system boundary and represents the functional behavior from the user's point of view.
\subsection{Use Case Diagram}

The Lets Go Ride Sharing App system includes 25 use cases covering registration, vehicle management, ride creation, booking, execution, safety, disputes, machine learning recommendations, chatbot support, and manual payment. The diagrams that follow illustrate the thematic groupings and the interactions between the Driver, Passenger, Admin, and supporting service APIs.
\subsection{Use Case Descriptions}

This section provides detailed tabular specifications of all major use cases. These use cases form the basis for deriving functional requirements and are organized by thematic modules.
