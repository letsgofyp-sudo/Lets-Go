...
urlpatterns = [
    ...
    path('sos/<int:incident_id>/resolved-snapshot/', views.resolved_sos_snapshot_detail_view, name='resolved_sos_snapshot_detail'),
    path('sos/<int:incident_id>/resolved-snapshot/regenerate/', views.resolved_sos_snapshot_regenerate_view, name='resolved_sos_snapshot_regenerate'),
