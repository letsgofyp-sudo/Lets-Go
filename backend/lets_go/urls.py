...
from .views import views_homescreen
from .views import views_rideposting
from .views import views_ridebooking
from .views import views_negotiation
from .views import views_blocking
from .views import views_chat
from .views import views_notifications
from .views import views_post_booking
from .views import views_incidents
from .views import views_support_chat
from .views import views_user_notifications
...
urlpatterns = [
    ...
    path('users/<int:user_id>/auto-archive/', views_rideposting.trigger_auto_archive_for_driver, name='trigger_auto_archive_for_driver'),
    path('users/<int:user_id>/rides/history/', views_rideposting.get_user_created_rides_history, name='get_user_created_rides_history'),
    ...
    path('users/<int:user_id>/blocked/search/', views_blocking.search_users_to_block, name='search_users_to_block'),
    path('users/<int:user_id>/blocked/block/', views_blocking.block_user, name='block_user'),
    ...
    # Password
    path('users/<int:user_id>/password/change/', views_authentication.change_password, name='change_password'),
    ...
    path('users/<int:user_id>/bookings/history/', views_rideposting.get_user_booked_rides_history, name='get_user_booked_rides_history'),
    ...
    path('cron/post-booking/reached-reminders/', views_post_booking.cron_post_booking_reached_reminders, name='cron_post_booking_reached_reminders'),
    # Chat endpoints
    ...
    path('notifications/', views_user_notifications.list_notifications, name='list_notifications'),
    path('notifications/unread-count/', views_user_notifications.notification_unread_count, name='notification_unread_count'),
    path('notifications/mark-all-read/', views_user_notifications.mark_all_notifications_read, name='mark_all_notifications_read'),
    path('notifications/<int:notification_id>/read/', views_user_notifications.mark_notification_read, name='mark_notification_read'),
