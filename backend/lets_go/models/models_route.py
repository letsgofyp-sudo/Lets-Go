...
class RouteGeometryPoint(models.Model):
    route = models.ForeignKey(Route, on_delete=models.CASCADE, related_name='geometry_points')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['route', 'point_index']),
        ]
