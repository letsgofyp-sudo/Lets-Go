...
try:
    ...
    from ..core import BOT_EMAIL, BOT_PASSWORD
    from ..engine_impl import handle_message
    from ..llm import cloud_model, llm_base_url, llm_brain_mode, llm_debug_enabled, llm_provider
    from ..core import BotContext, set_current_user
    ...
    from lets_go.utils.chatbot.core import BOT_EMAIL, BOT_PASSWORD
...
def _assert_api_backed(label: str, reply: str, *, allow_empty: bool = False) -> None:
    ...
    ok = (
        ...
        or ('Sorry, ' in s)
        or (s.strip() in {
            'This request was redirected. Please try again.',
            "Sorry, I couldn't complete that request. Please check your input and try again.",
