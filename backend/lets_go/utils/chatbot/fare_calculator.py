...
def calculate_fare(
    ...
    if len(route_stops) < 2:
        raise ValueError("At least two stops required for fare calculation")
    ...
    for i in range(len(route_stops) - 1):
        ...
        distance_km = from_stop.get("distance_from_previous_km", 0.0)
        duration_min = from_stop.get("duration_from_previous_minutes", 0)
    ...
    return {
        ...
        "calculation_breakdown": {
            ...
            "total_duration_minutes": total_duration,
            "total_price": final_total_price,
            "minimum_total_fare": minimum_total_fare,
            "base_rate_per_km": base_rate_per_km,
            "vehicle_multiplier": vehicle_multiplier,
            "time_multiplier": time_multiplier,
            "is_peak_hour": is_peak,
            "seat_factor": seat_factor,
            "distance_category": _get_distance_category(total_distance),
            "distance_factor": _DISTANCE_FACTORS[_get_distance_category(total_distance)],
            "fuel_cost": fuel_cost,
