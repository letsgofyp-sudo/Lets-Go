...
void main() {
  const sourcePath = 'lib/screens/ride_posting_screens/my_rides_screen.dart';
  final source = File(sourcePath).readAsStringSync();

  group('screens/ride_posting_screens/my_rides_screen.dart contract', () {
    test('source file is non-empty', () {
      expect(source.trim().isNotEmpty, isTrue);
    });
    test('declares expected classes', () {
      expect(source.contains('class MyRidesScreen'), isTrue);
      expect(source.contains('class _MyRidesScreenState'), isTrue);
    });
