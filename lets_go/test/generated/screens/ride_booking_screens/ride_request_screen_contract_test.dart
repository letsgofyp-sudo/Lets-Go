...
void main() {
  const sourcePath = 'lib/screens/ride_booking_screens/ride_request_screen.dart';
  final source = File(sourcePath).readAsStringSync();

  group('screens/ride_booking_screens/ride_request_screen.dart contract', () {
    test('source file is non-empty', () {
      expect(source.trim().isNotEmpty, isTrue);
    });
    test('declares expected classes', () {
      expect(source.contains('class RideRequestScreen'), isTrue);
      expect(source.contains('class _RideRequestScreenState'), isTrue);
    });
