...
void main() {
  const sourcePath = 'lib/screens/signup_login_screens/signup_cnic_screen.dart';
  final source = File(sourcePath).readAsStringSync();

  group('screens/signup_login_screens/signup_cnic_screen.dart contract', () {
    test('source file is non-empty', () {
      expect(source.trim().isNotEmpty, isTrue);
    });
    test('declares expected classes', () {
      expect(source.contains('class SignupCnicScreen'), isTrue);
      expect(source.contains('class _SignupCnicScreenState'), isTrue);
    });
