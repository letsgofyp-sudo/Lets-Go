...
void main() {
  const sourcePath = 'lib/screens/post_booking_screens/passenger_live_tracking_screen.dart';
  final source = File(sourcePath).readAsStringSync();

  group('screens/post_booking_screens/passenger_live_tracking_screen.dart contract', () {
    test('source file is non-empty', () {
      expect(source.trim().isNotEmpty, isTrue);
    });
    test('declares expected classes', () {
      expect(source.contains('class PassengerLiveTrackingScreen'), isTrue);
      expect(source.contains('class _PassengerLiveTrackingScreenState'), isTrue);
    });
