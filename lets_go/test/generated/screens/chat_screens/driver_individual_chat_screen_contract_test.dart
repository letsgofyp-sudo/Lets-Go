...
void main() {
  const sourcePath = 'lib/screens/chat_screens/driver_individual_chat_screen.dart';
  final source = File(sourcePath).readAsStringSync();

  group('screens/chat_screens/driver_individual_chat_screen.dart contract', () {
    test('source file is non-empty', () {
      expect(source.trim().isNotEmpty, isTrue);
    });
    test('declares expected classes', () {
      expect(source.contains('class DriverIndividualChatScreen'), isTrue);
      expect(source.contains('class _DriverIndividualChatScreenState'), isTrue);
    });
